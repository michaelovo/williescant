                        ...
                        <div class="row">
                            <div class="col-md-4 border-md-right border-light text-center">
                                <img class="img-fluid rounded-circle mb-3"
                                    src="{{asset('storage/images/avatars/img1.jpg')}}" alt="Image description"
                                    width="84">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input id="username"
                                                        class="form-control @if($username_taken)is-invalid@endif"
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#change_password_form").submit(function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: "/willie-online-new/supplier/helpers/update_password.php",
                data: {
