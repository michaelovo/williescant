<header class="u-header">
    ...
    <div class="u-header-right">
        ...
        <a href="{{route('login')}}" class="link-muted nav-link">Login</a>
        <a href="{{route('register')}}" class="link-muted nav-link">Sign up</a>
        ...
        <div class="dropdown ml-2">
            ...
            <div class='dropdown-menu dropdown-menu-right border-0 py-0 mt-4' aria-labelledby="dropdownMenuLink"
                ...
                <div class='d-flex'>
                    ...
                    <a class='dropdown-item service' href='https://housingsmart.co.ke/homepage'><img src="{{asset('storage/images/main/housing.Jpg')}}" width='35' height='45'></a>
                </div>
